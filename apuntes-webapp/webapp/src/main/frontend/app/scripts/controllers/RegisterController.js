...
define([
  ...
  'services/programService'
    ...
    frontend.controller('RegisterController', [
      'sessionService', 'md5', '$location', '$rootScope', 'universityService', 'programService', 'spinnerService', 'errormodalService',
      function(sessionService, md5, $location, $rootScope, universityService, programService, spinnerService, errormodalService) {
        var _this = this;
