    ...
    <div class="content-wrapper">
        <div class="white-container">
            ...
            <div class="white-container-content">
                <form:form class="column left" method="POST" action="${postPath}" enctype="multipart/form-data"
                    ...
                    <div class="form-group column left input-base-wrapper">
                        ...
                        <input required="required" type='file' class="form-control input-base" name="multipartFile"
                               placeholder="<spring:message code="uploadview.document"/>" id="file"/>
                    </div>
