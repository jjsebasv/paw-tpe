            ...
            <div class="white-container-content">
                ...
                <form action="${loginUrl}" method="post" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="form-group column left">
                        <label class="control-label" for="username"><spring:message code="models.client.username"/></label>
                        <input type="text" class="form-control input-base" name="j_username" id="username">
                    </div>
                    <div class="form-group column left">
                        <label class="control-label" for="password"><spring:message code="models.client.password"/></label>
