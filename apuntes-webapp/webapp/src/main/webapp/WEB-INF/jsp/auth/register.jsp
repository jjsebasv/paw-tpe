                                            ...
                                            <form:input class="form-control" type="email" path="email"/>
                                                ...
                                                <form:input class="form-control" type="password" path="password"/>
                                                    ...
                                                    <div class="column left form-group input-base-wrapper ${not empty repeatPasswordHasBindError?"has-error":""}">
                                                        <form:label path="repeatPassword"><spring:message code="register.repeat.password"/>:
                                                        </form:label>
                                                        <form:input class="form-control" type="password" path="repeatPassword"/>
                                                            ...
                                                            <div class="item-center">
                                                                <input class="base-button" type="submit" value="<spring:message code="register.submit"/>"/>
                                                            </div>
                                                        </form:form>
                                                    </div>
                                                </div>
