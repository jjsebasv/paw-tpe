        ...
        <div class="white-container-content">
            ...
            <div class="document-info">
                <div class="row row-center">
                    <a class="base-button" href="profile/change_password">
                        <spring:message code="models.client.password.change"/>
                    </a>
                </div>
            </div>

            <h4 class="client-size"><c:out value="${documentsSize}"/> <spring:message
                    code="profile.document.size"/></h4>
                ...
                <c:forEach items="${reviews}" var="review">
                    <li class="list-item">
                        ...
                        <a href="document/${review.file.documentId}"
                           class="list-group-item">
                                <span><b><c:out value="${review.review}"/></b> <spring:message
                                        code="profile.review.to"/> </span>
